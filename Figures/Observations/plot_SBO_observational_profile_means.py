...
def plot_transect_profile_means(project_dir, transect, date_str, transect_line_32602, transect_distance,
    ...
    gs = GridSpec(1,2, figure=fig, left=0.08, right=0.92, top=0.95, bottom=0.08)
    ...
    output_file = os.path.join(project_dir, 'Figures', 'Model', f'{transect}_observations_profile_{date_str}.png')
